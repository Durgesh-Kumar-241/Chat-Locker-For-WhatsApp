...
import com.dktechhub.chatlockerforwhatsapp.utils.LockActivity;
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void setData() {
            ...
            if (findPreference != null) {
                findPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    /* class com.vestaentertainment.whatsappchatloker.SettingsActivity.SettingsFragment.C07511 */
            ...
            findPreference("battery_optimize").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                /* class com.vestaentertainment.whatsappchatloker.SettingsActivity.SettingsFragment.C07522 */
            ...
            switchPreference.setChecked(MainActivity.isAccessibilitySettingsOn(getActivity()));
            switchPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                /* class com.vestaentertainment.whatsappchatloker.SettingsActivity.SettingsFragment.C07533 */
            ...
            findPreference("changepin").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                /* class com.vestaentertainment.whatsappchatloker.SettingsActivity.SettingsFragment.C07544 */
        ...
        public void showChangePinDialog() {
            new AlertDialog.Builder(getActivity()).setTitle(getString(R.string.app_name)).setMessage(getString(R.string.changepinDialog)).setIcon(R.mipmap.ic_launcher).setCancelable(true).setNegativeButton(getResources().getString(R.string.f69no), new DialogInterface.OnClickListener() {
                /* class com.vestaentertainment.whatsappchatloker.SettingsActivity.SettingsFragment.DialogInterface$OnClickListenerC07566 */

                public void onClick(DialogInterface dialogInterface, int i) {
                    dialogInterface.dismiss();
                }
            }).setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.vestaentertainment.whatsappchatloker.SettingsActivity.SettingsFragment.DialogInterface$OnClickListenerC07555 */
        ...
        public void showAccessibilitySettings() {
            new AlertDialog.Builder(getActivity()).setTitle(getString(R.string.app_name)).setMessage(getString(R.string.accessibility_service_des)).setIcon(R.mipmap.ic_launcher).setCancelable(false).setPositiveButton(getResources().getString(R.string.enable), new DialogInterface.OnClickListener() {
                /* class com.vestaentertainment.whatsappchatloker.SettingsActivity.SettingsFragment.DialogInterface$OnClickListenerC07599 */
